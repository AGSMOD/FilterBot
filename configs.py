...
if bool(environ.get("WEBHOOK", False)):
    ...
    try:
        BOT_TOKEN = environ.get("BOT_TOKEN", "6835125869:AAGWrHgrJezV3DZYVHz-JA4izYAIISdHLGc")
    except Exception as e:
    ...
    BOT_PICS = (environ.get('BOT_PICS', "https://telegra.ph/file/5254eb3ce91431dd02554.jpg")).split()

    FORCE_SUB = environ.get("UPDATE_CHANNEL", "https://t.me/AgsMods")

    SUPPORT_CHAT = environ.get("SUPPORT_CHAT", "https://t.me/Agsmods_Support")
